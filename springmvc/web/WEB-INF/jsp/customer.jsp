...
<%@ taglib prefix="lpy" uri="http://lpy.cn/common/" %>
<%
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" action="${pageContext.request.contextPath }/customer/list.action"
                    ...
                    <button id="add_user" data-toggle="modal"
                            data-target="#customerAddDialog" type="button" class="btn btn-primary">添加
                    </button>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel1">新增客户信息</h4>
            </div>
